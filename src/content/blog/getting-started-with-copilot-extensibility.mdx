...
> [!NOTE]
> This guide assumes you have basic knowledge of TypeScript and REST APIs. If you're new to these technologies, we recommend familiarizing yourself with them first.
...
> [!WARNING]
> Never hardcode API keys or secrets in your code. Always use secure storage mechanisms like Azure Key Vault or environment variables.

> [!TIP]
> Use OAuth 2.0 with refresh tokens for the best user experience. This allows your plugin to access resources without repeatedly prompting users for credentials.
...
> [!INFO]
> Following these best practices will help you build robust, maintainable, and secure Copilot plugins that provide excellent user experiences.
...
- 📚 [Copilot API Reference](https://docs.microsoft.com/copilot/api)
- 🎥 [Video Tutorial Series](https://youtube.com/copilot-dev)
- 💬 [Developer Discord](https://discord.gg/copilot)
- 🛠️ [Plugin Templates](https://github.com/microsoft/copilot-templates)
