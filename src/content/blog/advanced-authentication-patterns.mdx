...
> **Warning:** Never hardcode API keys or secrets in your code. Always use secure storage mechanisms like Azure Key Vault or environment variables.

![OAuth 2.0 Authentication Flow](/images/auth-flow.svg)
