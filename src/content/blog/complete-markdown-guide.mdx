...
- [Hyperlinks](https://github.com/sebastienlevert/copilot-stack) to external resources
...
|---------|-----------|-------|
| **Code Highlighting** | ✅ | All major languages |
| **Line Numbers** | ✅ | Automatic |
| **Mermaid Diagrams** | ✅ | All diagram types |
| **Admonitions** | ✅ | 6 types available |
| **Copy Code** | ✅ | One-click copying |
| **Anchor Links** | ✅ | All headings |
...
function Test-ApiHealth {
    ...
    try {
        Write-Host "🔍 Checking endpoint: $Endpoint" -ForegroundColor Cyan
...
- [GitHub Repository](https://github.com/sebastienlevert/copilot-stack)
...
- View the [source code](https://github.com/sebastienlevert/copilot-stack) to see how these features are implemented
